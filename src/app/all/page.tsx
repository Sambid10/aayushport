        ...
        >
          <TabsList className="grid w-[50%] h-[4.2rem] grid-cols-2 mb-10  border border-gray-800 bg-gray-900 text-[#fff] rounded-full">
            ...
            >
              ...
              <TabsTrigger
                className="text-lg text-gray-200 font-medium h-[80%]  rounded-full w-full hover:bg-gray-700 ease-in duration-200 transition-colors"
                value="Poster"
              >
                Poster Designs
              </TabsTrigger>
            ...
            >
              <TabsTrigger
                className="text-lg text-gray-200 font-medium h-[80%]  w-full rounded-full  hover:bg-gray-700 ease-in duration-200 transition-colors"
                value="tee-designs"
              >
                Tee Designs
              </TabsTrigger>
